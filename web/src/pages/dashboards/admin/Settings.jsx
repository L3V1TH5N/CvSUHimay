...
// Helper to resolve full avatar URL
...
const Settings = () => {
  ...
  const initials = (user?.full_name || user?.email || "A")[0].toUpperCase();
    ...
    <div className="settings-page">
      ...
      <div className="settings-layout">
        ...
        <div className="settings-content">
          ...
          {/* Profile */}
          <section ref={sectionRefs.profile} id="profile" className="settings-section">
            ...
            <form className="settings-section-body" onSubmit={e => { e.preventDefault(); handleSaveProfile(); }}>
          ...
          <section ref={sectionRefs.appearance} id="appearance" className="settings-section">
            <div className="settings-section-header">
          ...
          <section ref={sectionRefs.security} id="security" className="settings-section">
            <div className="settings-section-header">
            ...
            <form className="settings-section-body" onSubmit={e => { e.preventDefault(); handlePasswordChange(); }}>
              ...
              <div className="settings-actions">
                <button type="submit" disabled={pwSaving} className="settings-btn-primary">
